...
public class AmazonTranscribeConfiguration {
	...
	/**
	 * Registers AmazonTranscribe.class bean object in the Spring IOC container
	 * which then can be autowired directly into the consuming class to communicate
	 * with Amazon Transcribe service. The bean is constructed using the IAM user
	 * security credentials defined in the active .properties file @see
